...
insert INTO AUG_REQUEST (REQUEST_DATE,REQUESTER_NAME,STATUS,APPROVAL_NAME,APPROVAL_DATE,REQUEST_POSITION,NUMBER_APPLICANT,SPECIFIC_SKILL,YEAR_EXPERIENCE)
