...
<f:form method="post" name="reportForm" target="_blank" commandName="applicant" action="${pageContext.request.contextPath}/searchEEReport" cssClass="form-horizontal">
        ...
        <div class="form-group form-group-sm">
        	...
        	<div class="col-sm-6">
        		<f:select path="sortingBy" cssClass="form-control">
        			<f:option value="applicantCode">Applicant Code</f:option>
        		</f:select>
        	</div>
        </div>
         <div class="form-group form-group-sm">
