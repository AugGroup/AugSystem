...
=======
								...
								<input type="text" class="form-control" id="universityId" name="universityName" placeholder="Enter university">
							</div>

							<div class="form-group">
								<label for="degree">Degree </label> 
								<input type="text" class="form-control" id="degreeId" name="degreeName" placeholder="Enter degree">
							</div>

							<div class="form-group">
								<label for="faculty">Faculty </label> 
								<input type="text" class="form-control" id="facultyId" name="facultyName" placeholder="Enter faculty">
							</div>
							<div class="form-group">
								<label for="major">Major </label> 
								<input type="text" class="form-control" id="majorId" name="majorName" placeholder="Enter major">
							</div>
							<div class="form-group">
								<label for="gpa">GPA </label> 
								<input type="text" class="form-control" id="gpaId" name="gpaName" placeholder="Enter GPA">
							</div>

							<div class="form-group">
								<label for="graduate">Years of graduate </label> 
								<input type="text" class="form-control" id="graduateId" name="graduateName" placeholder="Enter years of graduate">
>>>>>>> Edit ApplicantController,ApplicationController,applications.jsp,educations.jsp,main_applicant.jsp
							</div>
							<br> <br>
