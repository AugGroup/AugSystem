...
<script
	src='<c:url value ="/static/resources/js/jquery.inputmask.bundle.js" />'></script>
<script
	src='<c:url value ="/static/resources/js/jquery.inputmask.bundle.min.js" />'></script>
<%-- 
			...
			<div class="user">
				<a href="<c:url value="/logout"/>"
					...
					class="glyphicon glyphicon-log-out"></span> <spring:message
						code="sitemesh.logout" /></a> <a href="" style="color: #707070;"><span
				...
				<div class="user2">
					...
					<a href="${request.getRequestURL}?locale=th"> <img
						src="${pageContext.request.contextPath}/static/decorators/thai_flag.jpg"
						alt="logo" class="img-flag"
						style="width: 40px; height: 25px; margin-right: 15px;" /></a>
					<div class="btn-group">
						<button type="button" class="btn btn-defult dropdown-toggle"
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
							id="btn_report" style="color: #ffffff;">
							<spring:message code="report.text" />
							<span class="caret"></span>
						</button>
						<ul class="dropdown-menu">
							<li><a href="${pageContext.request.contextPath}/report"
								style="font-size: 16px; color: #292929;"><spring:message
		...
		<div class="text">
			<div class="container">
				<p class="text-muted credit">&copy; 2011-2015 Augmentis
					(Thailand) Limited. All rights reserved.</p>
			</div>
		</div>
	</div>
